...
- 🤖 [AI Job Matching & Progress Tracker](https://github.com/DarakshanSaara/narishakti-frontend): React + Flask app using embedding similarity logic for job recommendations and user progress tracking.
...
- # ✅ Problem Categories:
  **Arrays, Linked List, String, Two pointers, Dynamic Programming, Stack, Queue, Tree, Graph, Union-Find, Sorting, Searching, Greedy, Hash Table**  
